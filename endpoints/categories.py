...
class CategoriesResource(Resource):
    ...
    def get(self, category_id=None):
        ...
        if category_id is not None:
            category = next(
                (p for p in self.categories_data if p["id"] == category_id), None
            )
    ...
    def post(self):
        ...
        self.parser.add_argument(
            "name", type=str, required=True, help="Name of the category"
        )
        ...
        if any(cat["name"] == new_category_name for cat in categories):
        ...
        self.db.save_categories(self.categories_data)
    ...
    def delete(self):
        ...
        category_to_remove = next(
            (cat for cat in self.categories_data if cat["name"] == category_name), None
        )
