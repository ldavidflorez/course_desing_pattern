...
class Container(containers.DeclarativeContainer):
    ...
    category_repo = providers.Singleton(JsonCategoryRepository, json_file_path="db.json")
    favorite_repo = providers.Singleton(JsonFavoriteRepository, json_file_path="db.json")
